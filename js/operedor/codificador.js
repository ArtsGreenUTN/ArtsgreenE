export function generateMD5Hash(data) {
  ...
  let x = [], k, AA, BB, CC, DD, a, b, c, d, S11 = 7, S12 = 12, S13 = 17, S14 = 22,
  ...
  const tempResult = wordToHex(a) + wordToHex(b) + wordToHex(c) + wordToHex(d);
